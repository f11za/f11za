...
Robotics: Working on behavioral programming and research for human-robot interaction.

FinTech: Built a Personal Finance Dashboard using Next.js, Plaid API, and Supabase.
